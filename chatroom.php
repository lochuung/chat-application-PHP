        ...
        <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
          <li class="nav-item ms-2 dropdown">
            <a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="avatar-img rounded-2" src="<?php echo $user_data['profile'] ?>" alt="" />
            </a>
              ...
              <li class="px-3">
                <div class="d-flex align-items-center position-relative">
                  ...
                  <div class="avatar me-3">
                    <img class="avatar-img rounded-circle" src="<?php echo $user_data['profile'] ?>" alt="avatar" />
                  </div>
                  <div>
                    <a class="h6 stretched-link" href="#"><?php echo $user_data['name'] ?></a>
                  </div>
                </div>
                <a class="dropdown-item btn btn-primary-soft btn-sm my-2 text-center" href="profile.php">Sửa hồ sơ</a>
              </li>
              <li class="dropdown-divider"></li>
              <li>
                <a class="dropdown-item bg-danger-soft-hover" href="logout.php"><i class="bi bi-power fa-fw me-2"></i>Đăng xuất</a>
              </li>
              <li>
